...
if [ ${2} = "spread" ]; then
    ...
    do 
        CUDA_VISIBLE_DEVICES=${gpu} python agent/model_based/main.py simple_spread ${1} --cuda --gpu_rollout_model --algorithm ${3} --model_hidden_dim 512 --model_lr 0.001 --n_epoch 100 --n_model_warmup_episode 1500 --opp_lr 0.0005  --dynamics_model_update_step_interval 3750 --Env_rate_n_epoch 40 --Env_rate_start 0.5 --Env_rate_finish 0.5 --G 20 --M 1024 --model_lr_schedule_steps 8000 --K 15 --A 5 --B 25 --seed ${seed}
    done
